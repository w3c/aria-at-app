...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async transaction => {
      ...
      await queryInterface.removeColumn('TestPlanReport', 'coveragePercent', {
        transaction
      });
      ...
      await queryInterface.removeColumn('TestPlanRun', 'isManuallyTested', {
        transaction
      });
      await queryInterface.addColumn(
        'TestPlanRun',
  ...
  down: async (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async transaction => {
      ...
      await queryInterface.renameColumn('TestPlan', 'status', 'publishStatus', {
        transaction
      });
      await queryInterface.renameColumn(
        'TestPlan',
      ...
      await queryInterface.renameColumn('TestPlan', 'updatedAt', 'createdAt', {
        transaction
      });
