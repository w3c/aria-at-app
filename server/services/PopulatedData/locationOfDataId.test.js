...
describe('locationOfDataId', () => {
  it("creates ids which contain the parent's locationOfData", () => {
    ...
    const scenarioResultId = createScenarioResultId(testResultId, scenarioId);
    ...
    const decodedScenarioResultId = decodeLocationOfDataId(scenarioResultId);
    const decodedAssertionResultId = decodeLocationOfDataId(assertionResultId);
