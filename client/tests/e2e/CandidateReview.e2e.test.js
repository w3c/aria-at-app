  ...
  it('shows summary view as first page and navigates correctly', async () => {
    await getPage(
      ...
      async (page, { consoleErrors }) => {
        ...
        await page.click('a[href="#summary-failures"]');
        ...
        await page.waitForSelector(
          'a[href="#summary-failures"][aria-current="true"]'
        );
  ...
  it('shows failing assertions summary content', async () => {
    await getPage(
      ...
      async (page, { consoleErrors }) => {
        ...
        await page.click('a[href="#summary-failures"]');
        await page.waitForSelector('h1::-p-text(Summary of Failures)');
