    ...
    <BasicModal
      ...
      content={
        <div className="feedback-content">
          ...
          <Form>
            <Form.Group onChange={e => setSelectedRadio(e.target.id)}>
              <FormCheck>
                <FormCheck.Input
                  id="not-approved-input"
                  name="radio-feedback"
                  type="radio"
                  defaultChecked={selectedRadio === 'not-approved-input'}
                />
      ...
      actions={[
        {
          ...
          onClick: () => {
            handleAction(selectedRadio === 'approve-input' ? 'APPROVED' : '');
          }
        }
      ]}
      title={
        <>
          <p className="sr-only">
            Great {username}! You have reviewed every test in the {testPlan}{' '}
            with {at}
          </p>
          <div className="feedback-title" aria-hidden="true">
            <span className="feedback-bold">Great, {username}!</span> You have
            reviewed every test in the{' '}
