            ...
            <Nav>
              ...
              <li>
                <Nav.Link
                  ...
                  to="/test-queue"
                  aria-current={
                    location.pathname.includes('/test-queue') ||
                    location.pathname.includes('/run') ||
                    location.pathname.includes('/test-plan-report')
                  }
                >
                  Test Queue
                </Nav.Link>
              ...
              {isSignedIn && (isAdmin || isVendor) && (
                <li>
                  <Nav.Link
                    as={Link}
                    to="/candidate-review"
                    aria-current={location.pathname.startsWith('/candidate')}
                  >
                    Candidate Review
                  </Nav.Link>
                </li>
                  ...
                  {!isVendor && (
                    <li>
                      <Nav.Link
                        as={Link}
                        to="/account/settings"
                        aria-current={location.pathname === '/account/settings'}
                      >
                        Settings
                      </Nav.Link>
                    </li>
