        ...
        return (
            <Fragment>
                ...
                <p>
                    ...
                    on examples from WAI-ARIA Authoring Practices, and are
                    vetted with stakeholders following the working mode process.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        <a>Sign up as a tester</a>
                    </li>
                    <li>
                        <a>Write more tests</a>
                    </li>
                    <li>
                        <a>Review the assertions of existing test plans</a>
                    </li>
                    <li>
                        <a>Review test results</a>
                    </li>
                    <li>
                        <a>Fix a good first issue</a>
                    </li>
                </ul>
            </Fragment>
        );
