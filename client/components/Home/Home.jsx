      ...
      <section className="get-involved">
        <div className="container">
          ...
          <p>
            ...
            Community Group is currently focusing on a stable and mature test
            suite for five screen readers. In the future, we plan to test
            additional screen readers and other kinds of assistive technologies
            with a broader set of web design patterns and test material.
          </p>
