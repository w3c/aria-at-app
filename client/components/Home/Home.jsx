          ...
          <div className="hero-copy">
            <p className="w3c-authorization-message">
              ...
              <em>
                ...
                <a href="mailto:dmontalvo@w3.org">Daniel Montalvo</a>.
              </em>
            </p>
            <p>
              Today, different screen readers often yield conflicting
              experiences when presenting a web page, disadvantaging or even
              excluding some users. These differences also create accessibility
              design and test barriers for web developers.
            </p>
            <p>
              On the other hand, browsers are interoperable for people who do
              not use assistive technologies. That is, different browsers
              provide equivalent experiences. Browser interoperability
              facilitates an inclusive web.
            </p>
            <p>
              Assistive technology users deserve equal inclusion. The ARIA-AT
              project aims to empower equal inclusion by realizing
            ...
            <p>
              ...
              >
                ...
                inclusion on the web for people with disabilities.
              </a>
            </p>
          </div>
        ...
        <div className="improvements-container">
          ...
          <ul className="improvement-list">
            <li>
              ...
              <p>
                We have written initial drafts for more than a thousand tests
                that articulate expected screen reader behaviors for 40 examples
                of common web design patterns. View the{' '}
            ...
            <li>
              ...
              <p>
                ...
                multiple testers, review results, and publish reports. View our
                progress on the <Link to="/test-queue">test queue</Link> page.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                consensus around the plan begins. View reports generated from
                candidate test plans on the <Link to="/reports">reports</Link>{' '}
                page.
              </p>
            </li>
            <li>
              ...
              <p>
                In order to regularly collect test results at scale for multiple
                web design patterns, browsers, and ATs, we are developing an
                industry standard for automating assistive technology. Read the{' '}
      ...
      <section className="get-involved">
        <div className="container">
          ...
          <p>
            ...
            requires industry-wide collaboration and support. The W3C ARIA-AT
            Community Group is focusing on a stable and mature test suite for
            five screen readers by the end of 2023. In the future, we plan to
            test additional screen readers and other kinds of assistive
            technologies with a broader set of web design patterns and test
            material.
          </p>
          ...
          <ol>
            <li>
              <a href="https://github.com/w3c/aria-at/wiki/Contributing-to-the-ARIA-and-Assistive-Technologies-Project">
                Reading more about the project and spreading awareness of its
                mission
              </a>
            </li>
            <li>
