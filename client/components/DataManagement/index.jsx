...
const DataManagement = () => {
  ...
  const [deprecatedTestPlanVersions, setDeprecatedTestPlanVersions] = useState(
    []
  );
        ...
        <thead>
          <tr>
            <SortableTableHeader
              title="Test Plan"
              active={
                activeSort.key === DATA_MANAGEMENT_TABLE_SORT_OPTIONS.NAME
              }
              onSort={direction =>
                updateSort({
            ...
            <SortableTableHeader
              title="Covered AT"
              active={activeSort.key === DATA_MANAGEMENT_TABLE_SORT_OPTIONS.ATS}
              onSort={direction =>
                updateSort({
            ...
            <SortableTableHeader
              ...
              active={
                activeSort.key === DATA_MANAGEMENT_TABLE_SORT_OPTIONS.PHASE
              }
              onSort={direction =>
                updateSort({
            ...
            return (
              <DataManagementRow
                ...
                testPlanVersions={[
                  ...
                  testPlanVersion =>
                    testPlanVersion.testPlan.directory === testPlan.directory
                )}
                tableRowIndex={index}
