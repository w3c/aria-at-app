...
class TestRun extends Component {
    ...
    handleSaveResultClick() {
        ...
        if (!resultsEl) {
            ...
            console.log("saving failed cause no results");
            return;
        }
            ...
            if (!this.state.runComplete) {
                ...
                if (true) {
                    content = (
                        <React.Fragment>
                            <iframe
                                ...
                                ref={this.testIframe}
                            ></iframe>
                            <Button variant="primary" onClick={this.handleSkipTestClick}>
                                Skip to next test
                            </Button>
                            <Button variant="primary" onClick={this.handleSaveResultClick}>
                    ...
                    content = (
                        <React.Fragment>
                            <div>
                              RESULTS EXIST!!!!!! TODO: Make a view of the existng tests
                            </div>
