...
const ManageTestQueue = ({
  ...
  useEffect(() => {
    if (ats.length) {
      ...
      if (!loadedAts.current) setSelectedManageAtVersions(ats[0].atVersions);
      else
    ...
    <LoadingStatus message={loadingMessage}>
      <DisclosureComponent
        ...
        disclosureContainerView={[
          ...
          <DisclosureContainer key={`manage-test-queue-add-test-plans-section`}>
            <span>
              Select a Test Plan and version and an Assistive Technology and
              Browser to add it to the Test Queue
            </span>
            <div className="disclosure-row-test-plans">
              <Form.Group className="form-group">
                ...
                >
                  {filteredTestPlanVersions.map(item => (
                    <option
                      key={`${item.title || item.testPlan.directory}-${
                        item.id
                      }`}
                      value={item.id}
                    >
              ...
              <Form.Group className="form-group">
                ...
                <Form.Select
                  value={
                    selectedTestPlanVersionId ? selectedTestPlanVersionId : ''
                  }
