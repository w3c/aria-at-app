            ...
            >
              ...
              <tbody>
                {testPlanReport.finalizedTestResults.map(testResult => {
                  const { requiredFormatted, optionalFormatted, mayFormatted } =
                    getMetrics({
                      testResult
                    });
                  return (
                    <tr key={testResult.id}>
                      ...
                      <td>{requiredFormatted || none}</td>
                      <td>{optionalFormatted || none}</td>
                ...
                <tr>
                  <td>All Tests</td>
                  <td>{overallMetrics.requiredFormatted || none}</td>
                  <td>{overallMetrics.optionalFormatted || none}</td>
